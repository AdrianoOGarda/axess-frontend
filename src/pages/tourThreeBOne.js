...
function TourThreeBOne() {
    ...
    return (
        ...
        {furnitures?.filter(furniture => furniture?.category?.en === "BEDS" && furniture?.project === "AWA").map((filteredFurniture, i) => (
                ...
                onSelectImage={() => {
                    addToCart(filteredFurniture.name[t.lang], filteredFurniture.image, filteredFurniture.category.en, filteredFurniture.category.en, filteredFurniture.description[t.lang], filteredFurniture.price)
                    setSelected(i);
        ...
        {furnitures?.filter(furniture => furniture?.category?.en === "NIGHTSTANDS" && furniture?.project === "AWA").map((filteredFurniture, i) => (
                ...
                onSelectImage={() => {
                    addToCartNight(filteredFurniture.name[t.lang], filteredFurniture.image, filteredFurniture.category.en, filteredFurniture.category.en, filteredFurniture.description[t.lang], filteredFurniture.price);
                    setSelectedNight(i);
                    goToTV(goToTVRef);
                }}
                />
        ...
        {furnitures?.filter(furniture => furniture?.category?.en === "TV STANDS" && furniture?.project === "AWA").map((filteredFurniture, i) => (
                ...
                normalProductAdd={() => {
                    normalAdd(filteredFurniture.name[t.lang], filteredFurniture.image, filteredFurniture.category.en, filteredFurniture.category.en, filteredFurniture.description[t.lang], filteredFurniture.price);
                    setSelectedNormal(i);
